...
const ContactForm = (props) => {
    ...
    const [cacahueteBoth, setCacahueteBoth] = useState(false);
    ...
    return (<>
        ...
        <form className={style.myForm} onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input type='checkbox' id='cacahuetes_choiceBoth' onChange={(e) => setCacahueteBoth(e.target.checked)} checked={cacahueteBoth} />
                <label htmlFor='cacahuetes_choiceBoth'>Les deux</label>
            </div>
